    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_start_demo1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 刻意以“包名”来打开
                RePlugin.startActivity(MainActivity.this, RePlugin.createIntent("demo1", "com.example.demo1.MainActivity"));
                Toast.makeText(MainActivity.this,"Start demo1",Toast.LENGTH_SHORT).show();
            }
        });
...
//                // 若没有安装，则直接提示“错误”
//                // TODO 将来把回调串联上
//                if (RePlugin.isPluginInstalled("demo1")) {
//                    RePlugin.startActivity(MainActivity.this, RePlugin.createIntent("demo1", "com.example.demo1.MainActivity"));
//                } else {
